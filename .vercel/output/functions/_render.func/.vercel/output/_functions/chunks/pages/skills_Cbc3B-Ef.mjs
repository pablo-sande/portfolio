/* empty css                            */
import { e as createAstro, f as createComponent, o as defineStyleVars, r as renderTemplate, m as maybeRenderHead, i as addAttribute, j as renderComponent, u as unescapeHTML, n as Fragment } from '../astro_DAHCdQnY.mjs';
/* empty css                           */
import { c as client, $ as $$Layout } from './index_B6Kalj82.mjs';
...
const $$SkillCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="p-[12px] rounded-full skillbox spin relative h-[150px] w-[150px] m-auto" data-astro-cid-u5aykeor${addAttribute($$definedVars, "style")}> <div class="bg-gray-200 relative rounded-full flex flex-col justify-center items-center w-full h-full" data-astro-cid-u5aykeor${addAttribute($$definedVars, "style")}> <div class="w-16 h-16" data-astro-cid-u5aykeor${addAttribute($$definedVars, "style")}> ${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate`${unescapeHTML(item.thumbnail)}` })} </div> <h2 class="font-bold text-lg text-gray-800 text-center" data-astro-cid-u5aykeor${addAttribute($$definedVars, "style")}> ${item.title} </h2> </div> </div> `;
...
const $$Skills = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "skills", "data-astro-cid-xahix5fp": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<article class="max-w-screen-lg m-auto p-4 sm:p-6 relative" data-astro-cid-xahix5fp> <h1 class="enter-animation-title text-2xl sm:text-4xl font-bold text-gray-300" data-astro-cid-xahix5fp> <span class="lg:inline hidden" data-astro-cid-xahix5fp>Hover</span> <span class="lg:hidden block inline" data-astro-cid-xahix5fp>Click</span>
