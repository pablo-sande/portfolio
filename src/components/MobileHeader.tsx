...
export const MobileHeader = () => {
	...
	return (
		<>
			...
			>
				<div className={'btn ' + (isOpen ? 'active' : 'not-active')}>
			...
			{isOpen && (
				<div className="fixed left-0 h-full top-0 w-full flex flex-col justify-center items-center z-10 menu-in">
					<div className="fixed left-0 -z-10 h-full top-0 w-full">
						<div className="absolute h-full top-0 w-full z-[-2] bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]"></div>
					</div>

					<div className="text-white text-3xl">Menu</div>
